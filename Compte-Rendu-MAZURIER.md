...
![alt text](https://github.com/LesDeuxM/Projet-Maison-Connectee/blob/master/Annexe/Screenshot_20181214-190624_Smart'%20House.jpg?raw=true =250x "Screenshot de l'app")
Du coté Arduino, un delay manquant nous a fait perdre un peut de temps car les informations envoyées par le téléphone n'arrivaient pas bien à l'Arduino : 
